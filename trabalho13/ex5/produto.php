...
class Produto
{
  ...
  // Método estático para excluir um produto dado o seu nome
  public static function GetByMarca($pdo, $marca)
  {
    try {
      $sql = "SELECT nome, marca, descricao FROM produto WHERE marca = :marca";


      // Preparar a declaração
      $stmt = $pdo->prepare($sql);

      // Atribuir o valor da variável $marca ao placeholder :marca
